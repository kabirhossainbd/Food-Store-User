...
import 'package:flutter_restaurant/view/screens/comboo_offer/combo_offer_screen.dart';
...
//*******Handlers*********
  ...
  // static Handler _restaurantHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) {
  //   RestaurantScreen _restaurantScreen = ModalRoute.of(context).settings.arguments;
  //   return _restaurantScreen != null ? _restaurantScreen : RestaurantScreen(restaurant: RestaurantModel(id: int.parse(params['id'][0])));
  // });
  ...
  static Handler _restaurantDetailsHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) {
    RestaurantDetailsScreen _restaurantDetailsScreen = ModalRoute.of(context).settings.arguments;
    return _restaurantDetailsScreen != null ? _restaurantDetailsScreen : RestaurantDetailsScreen(restaurantModel: RestaurantModel(id: int.parse(params['id'][0])));
  });
...
//*******Route Define*********
  static void setupRouter() {
   ...
   // router.define(Routes.RESTAURANT_SCREEN, handler: _restaurantHandler, transitionType: TransitionType.fadeIn);
    ...
    router.define(Routes.combo_offer_SCREEN, handler: _setMenuHandler, transitionType: TransitionType.fadeIn);
