            ...
            child: Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  child: ClipOval(
                    child: _isLoggedIn ? FadeInImage.assetNetwork(
                      ...
                      image: '${Provider.of<SplashProvider>(context,).baseUrls.customerImageUrl}/'
                          '${profileProvider.userInfoModel != null ? profileProvider.userInfoModel.data.image : ''}',
                ...
                Column(children: [
                  ...
                  SizedBox(height: 10),
                  _isLoggedIn ? profileProvider.userInfoModel != null ? Text(
                    '${profileProvider.userInfoModel.data.email ?? ''}',
                  ...
                  SizedBox(height: 10),
                  _isLoggedIn ? profileProvider.userInfoModel != null ? Text(
                    '${getTranslated('points', context)}: ${profileProvider.userInfoModel.data.point ?? ''}',
                    style: rubikRegular.copyWith(color: ColorResources.BACKGROUND_COLOR),
