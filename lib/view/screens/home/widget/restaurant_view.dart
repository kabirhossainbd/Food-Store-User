                          ...
                          return InkWell(
                              ...
                              child: Container(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  Expanded(child: Text( restaurant.restaurantList[index].address, maxLines: 1, overflow: TextOverflow.ellipsis, style: rubikRegular.copyWith(color: ColorResources.getGreyColor(context), fontSize: 12),)),
