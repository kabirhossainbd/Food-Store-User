...
class HomePageWithScrollBar extends StatefulWidget {

  @override
  _HomePageDemoState createState() => _HomePageDemoState();
}

class _HomePageDemoState extends State<HomePageWithScrollBar> with TickerProviderStateMixin {
            ...
            return Column(crossAxisAlignment: CrossAxisAlignment.center ,children: [
              ...
              Container(
                ...
                child: TabBar(
                  ...
                  tabs: tabs.map((e) => TabWidgetDemoScroll(e)).toList(),
                ),
              ),
...
class TabWidgetDemoScroll extends StatelessWidget {
  const TabWidgetDemoScroll(this.category);
  final TabCategoryScroll category;
  @override
  Widget build(BuildContext context) {
...
class TabCategoryScroll{
  ...
  TabCategoryScroll({@required this.category,@required this.selected, @required this.offsetForm,  });
  TabCategoryScroll copyWith(bool selected) => TabCategoryScroll(category: category, selected: selected, offsetForm: offsetForm);
}